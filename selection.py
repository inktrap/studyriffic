...
def check_select(restrictions):
    ...
    for select_restriction in select_restrictions:
        #print(math.modf(max_steps * select_restriction['argument'])[0])
        assert (math.modf(max_steps * select_restriction['argument']))[0] == 0.0, "selection arguments can not produce items less than 1."
...
def apply_select(select_restrictions):
    ...
    for select_restriction in select_restrictions:
        ...
        take_restrictions = max_steps * select_restriction['argument']
